...
export default function App() {
  ...
  async function getRavintola() {
    ...
    try {
      ...
      const url2 = `http://open-api.myhelsinki.fi/v1/places/?tags_search=Restaurant&distance_filter=60.166640739%2C24.943536799%2C2`;
  ...
  return (
    <View style={styles.container}>
            ...
            <Marker
              ...
              <Callout
                ...
                <Text
                  ...
                  Osoite:{'\n'}
                  {tiedot.location.address.street_address}
                </Text>
                ...
                <Text style={{ color: '#000000', fontSize: 10 }}>Klikkaa lisätietoja</Text>
              </Callout>
            </Marker>
          ))
        ) : (
      ...
      <View style={{ flexDirection: 'row', padding: 4, alignItems: 'center' }}>
        <TouchableOpacity style={styles.painike} onPress={() => getRavintola()}>
